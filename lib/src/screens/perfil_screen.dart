...
class MapScreenState extends State<PerfilScreen> with SingleTickerProviderStateMixin
{
  ...
  // Widget _listadoNotas(List<PerfilModel> notas)
  // {
  //   return ListView.builder(
  //     itemBuilder: (BuildContext context, index)
  //     {
  //       PerfilModel nota = notas[index];
  //       return Card(
  //         child: Column(
  //           children: [
  //             Text(nota.nombre!, style: TextStyle(fontWeight: FontWeight.bold),),
  //             Text(nota.apellido_paterno!),
  //             Row(
